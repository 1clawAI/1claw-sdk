...
export class BillingResource {
  ...
  async usage(): Promise<OneclawResponse<UsageSummaryResponse>> {
    return this.http.request<UsageSummaryResponse>("GET", "/v1/billing/usage");
  }
   ...
   */
  async history(limit?: number): Promise<OneclawResponse<UsageHistoryResponse>> {
    return this.http.request<UsageHistoryResponse>("GET", "/v1/billing/history", {
