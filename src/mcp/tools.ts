    ...
    inputSchema: {
        ...
        properties: {
            ...
            reason: {
                type: "string",
                description:
                    "Why the agent needs this secret (logged for audit)",
            },
        },
    ...
    inputSchema: {
        ...
        properties: {
            ...
            type: {
                type: "string",
                description:
                    "Type hint (e.g. 'api_key', 'password', 'token', 'generic')",
                default: "generic",
            },
        },
    ...
    inputSchema: {
        ...
        properties: {
            ...
            expires_at: {
                type: "string",
                description:
                    "ISO-8601 expiry date for the share (e.g. '2025-12-31T00:00:00Z')",
            },
            max_access_count: {
                type: "number",
                description:
                    "Maximum number of times the secret can be accessed (default: 5)",
                default: 5,
            },
        },
